...
def Atualizar():
    ...
    try:
        ...
        tot_diario = float(faturamento_por_barbeiro_diario[0])+float(faturamento_por_barbeiro_diario[1])+float(faturamento_por_barbeiro_diario[2])+float(faturamento_por_barbeiro_diario[3])
        ...
        tot_semanal = float(faturamento_por_barbeiro_semanal[0])+float(faturamento_por_barbeiro_semanal[1])+float(faturamento_por_barbeiro_semanal[2])+float(faturamento_por_barbeiro_semanal[3])
...
Frame_6_Widget_10_textvar = StringVar(value=f'R$-')
